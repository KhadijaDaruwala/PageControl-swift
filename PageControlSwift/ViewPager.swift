...
@objc public protocol  ViewPagerDataSource {
    ...
    @objc optional func pageControlDidEndScroll(index:Int)
...
public class ViewPager: UIView {
    ...
    func setupScrollView() {
        ...
        //       let scrollSize = CGSize(width: self.frame.size.height, height: self.frame.size.width)
    ...
    func reloadData() {
        if(dataSource != nil){
            ...
            pageControl.isHidden = (dataSource?.isPageControlVisible())!
        }
        self.pageControl.numberOfPages = numberOfItems
...
extension ViewPager: UIScrollViewDelegate{
    ...
    public func scrollViewDidEndScrollingAnimation(_ scrollView: UIScrollView) {
        ...
        if(dataSource?.pageControlDidEndScroll != nil){
            dataSource?.pageControlDidEndScroll!(index: Int(pageNumber))
        }
    }
